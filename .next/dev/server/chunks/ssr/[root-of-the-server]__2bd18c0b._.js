...
async function generateMetadata({ params }) {
    ...
    const seoData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCachedBlogPostSEO"])(slug);
    const stripHtml = (html)=>{
        return html.replace(/<[^>]*>/g, '').trim();
    };
    const excerpt = stripHtml(post.excerpt.rendered);
    const title = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$wordpress$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["decodeHtmlEntities"])(post.title.rendered);
    return {
        ...
        openGraph: {
            ...
            images: seoData.ogImage ? [
                seoData.ogImage
            ] : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$wordpress$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getBlogPostImage"])(post) ? [
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$wordpress$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getBlogPostImage"])(post)
            ] : undefined,
            type: 'article'
        },
...
async function BlogPostPage({ params }) {
    ...
    const articleSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["generateArticleSchema"])({
        headline: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$wordpress$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["decodeHtmlEntities"])(post.title.rendered),
    ...
    const breadcrumbSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$seo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["generateBreadcrumbSchema"])([
        ...
        {
            name: 'Blog',
            url: 'https://lascrucesdirectory.com/blog'
        },
        {
            name: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$wordpress$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["decodeHtmlEntities"])(post.title.rendered),
            url: `https://lascrucesdirectory.com/blog/${slug}`
        }
    ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2bd18c0b._.js.map