...
"[project]/app/components/ImageGallery.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ImageGallery({ images, altText }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ImageGallery.useEffect": ()=>{
            const handleKeyDown = {
                "ImageGallery.useEffect.handleKeyDown": (e)=>{
                    if (e.key === 'ArrowLeft') {
                        goToPrevious();
            ...
            }["ImageGallery.useEffect.handleKeyDown"];
            window.addEventListener('keydown', handleKeyDown);
            return ({
                "ImageGallery.useEffect": ()=>window.removeEventListener('keydown', handleKeyDown)
            })["ImageGallery.useEffect"];
        }
    }["ImageGallery.useEffect"], []);
...
//# sourceMappingURL=_ed0212aa._.js.map